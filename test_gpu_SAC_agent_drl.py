...
def get_parsers():
    ...
    parser.add_argument("--test_dataset", default="/data/mmWaveRL_Datasets/train_norm_v11")  # val_nolog_norm_v11
    ...
    parser.add_argument("--train_max_steps", default=100, type=int)
    # IQL
    ...
    parser.add_argument('--load_model', default='/data/mmWaveRL_Datasets/runs_gpu/tmp_v11_latest/savemodel/model-2968937.pt', type=str)
...
def test(args):
    ...
    if args.policy == 'SACpolicy':
        ...
        policy = load_checkpoint(policy, args.load_model)

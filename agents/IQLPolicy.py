...
class IQLpolicy(object):
    ...
    def __init__(
        ...
        self.critic = ActionCritic(state_dim, action_dim).to(device)
    ...
    def train(self, data_dict, batch_size=256, logger=None):
        self.total_it += 1
        ...
        state, action, next_state, reward, not_done = data_dict
